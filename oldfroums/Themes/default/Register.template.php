	...
	if ($context['visual_verification'])
	{
		if(!empty($modSettings['keycaptcha_is_active']) && ($modSettings['keycaptcha_is_active'] == 1 && !empty($modSettings['keycaptcha_private_key'])))
		{
			echo '
				...
				<div class="windowbg2">
					...
					<fieldset class="content">
						<dl class="register_form">
							<dt>
								<strong><label for="capcode">', $txt['keycaptcha_task_header'], ':</label></strong>
								<span class="smalltext">', $txt['keycaptcha_task_explain'], '</span>
							</dt>
							<dd>';
			...
			echo '					<input type="hidden" id="capcode" name="capcode" value="123" />'.$kc_o->render_js().'
								<noscript>', $txt['keycaptcha_message_noscript'], '</noscript>
							</dd>
						</dl>
					</fieldset>
				</div>';
